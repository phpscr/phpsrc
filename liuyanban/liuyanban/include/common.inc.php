...
define('DB_USER', 'root');
define('DB_PWD', '021120');
define('DB_NAME', 'liuyanban');
define('DB_CHARSET', 'UTF8');
if(IS_CONN) {
	//创建连接
	_connect_server(DB_HOST,  DB_USER, DB_PWD, DB_NAME);
	//指定数据库
	_select_db(DB_NAME);
	//设置字符集
...
if(_is_login()) {
	...
	$_message_result = mysqli_query($_conn,$_sql);
	$_message_row = mysqli_fetch_array($_message_result, MYSQLI_ASSOC);
