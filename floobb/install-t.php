<?php
    ...
    if (isset($_POST['username'])) {
        ...
        } elseif (strlen(trim(stripslashes($_POST['username']))) < 3) {
            unset($_POST['boardname']);
            unset($_POST['boarddescription']);
            unset($_POST['username']);
            unset($_POST['password']);
        ...
        } elseif (strlen(trim(stripslashes($_POST['password']))) < 3) {
            unset($_POST['boardname']);
            unset($_POST['boarddescription']);
            unset($_POST['username']);
            unset($_POST['password']);
        ...
        } elseif (!isValidEmail(trim(stripslashes($_POST['email'])))) {
            unset($_POST['boardname']);
            unset($_POST['boarddescription']);
            unset($_POST['username']);
            unset($_POST['password']);
        ...
        } elseif (preg_match("/^\w+$/", trim(stripslashes($_POST['username']))) != 1) {
            unset($_POST['boardname']);
            unset($_POST['boarddescription']);
            unset($_POST['username']);
            unset($_POST['password']);
