...
$lang=array(
	...
	'会员管理'=>array(
		...
		'customfield'=>"<a target=main href='$admin_file?adminjob=customfield&action=add'>添加</a> | <a target=main href='$admin_file?adminjob=customfield'>管理</a> 用户栏目<br>",
	),
	'批量删除管理'=>array(
	...
	'数据库管理'=>array(
		...
		'ptable'=>"<a target=main href='$admin_file?adminjob=ptable'>post分表</a><br>",
	),
	'风格管理'=>array(
