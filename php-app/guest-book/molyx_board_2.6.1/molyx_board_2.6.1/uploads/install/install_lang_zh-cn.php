...
$a_lang['install']['versiontoolow'] = '由于 PHP 版本太低( < 4.0.6 )，MolyX BOARD 无法正常安装。<br>请联系服务器管理员升级PHP。';
...
$a_lang['mysql']['award']['bbsbulid'] = '论坛建设奖'; 
$a_lang['mysql']['award']['bbsbulidexplain'] = '你对社区建设作出了不可磨灭的贡献，特发此奖。'; 
$a_lang['mysql']['award']['goodlove'] = '最佳情侣奖'; 
$a_lang['mysql']['award']['goodlovexplain'] = '不多说了，祝你们在以后的日子里更加幸福！'; 
$a_lang['mysql']['award']['excellencemod'] = '优秀斑竹奖'; 
$a_lang['mysql']['award']['excellencemodepl'] = '在您的管理的版面里会员热情高涨，特发此奖，请继续努力。'; 
$a_lang['mysql']['award']['bestproduce'] = '最佳创作奖'; 
$a_lang['mysql']['award']['bestproducepl'] = '你的创作有独到的新意，让大家受益非浅，特发此奖，请继续努力喔。'; 
$a_lang['mysql']['award']['pourgenius'] = '灌水天才奖'; 
$a_lang['mysql']['award']['pourgeniusepl'] = '你灌水真是厉害呀，值得大家学习，特发此奖。'; 
$a_lang['mysql']['award']['pasteimgmaster'] = '贴图大师奖'; 
$a_lang['mysql']['award']['pasteimgmasterepl'] = '您的贴图真不错，特发此奖，请继续努力。'; 
$a_lang['mysql']['award']['bbsencourge'] = '论坛鼓励奖'; 
$a_lang['mysql']['award']['bbsencourgepl'] = '由于你的努力，带动了大家的热情，特发此奖，希望你继续成为大家学习的目标。'; 
$a_lang['mysql']['award']['bbskavass'] = '论坛卫士奖'; 
$a_lang['mysql']['award']['bbskavassepl'] = '由于你的关心，让我们的论坛能在一片清静的天空中发展，特发此奖。'; 
$a_lang['mysql']['award']['chatgenius'] = '聊天天才奖'; 
$a_lang['mysql']['award']['chatgeniusepl'] = '聊吧聊吧'; 
$a_lang['mysql']['award']['beautyuse'] = '美眉专用章'; 
$a_lang['mysql']['award']['beautyusepl'] = '各位帅哥请注意哈！'; 
$a_lang['mysql']['award']['handsomeuse'] = '帅哥专用章'; 
$a_lang['mysql']['award']['handsomeusepl'] = '各位美眉请注意喔！'; 
$a_lang['mysql']['award']['bestflack'] = '最佳宣传奖'; 
$a_lang['mysql']['award']['bestflackepl'] = '由于你的带动，使我们的论坛人气更旺，特发此奖，加油喔。'; 
$a_lang['mysql']['award']['humormaster'] = '幽默大师奖'; 
$a_lang['mysql']['award']['humormasterepl'] = '你总能给人们带来欢乐，特发此奖。'; 
...
$a_lang['mysql']['cron']['bankloancheck'] = '贷款清查及欠款强制收回'; 
$a_lang['mysql']['cron']['bankloancheckdesc'] = '清查当日贷款到期未还用户，强制收回贷款，有必要的话变卖道具、积分进行偿还，如仍不够，个人破产，封禁用户'; 
$a_lang['mysql']['cron']['bankpayinterest'] = '支付存款利息'; 
$a_lang['mysql']['cron']['bankpayinterestdesc'] = '按照日利率向所有帐户状态正常的存款用户支付每日存款利息'; 
$a_lang['mysql']['cron']['award_promotion'] = '自动颁发勋章'; 
$a_lang['mysql']['cron']['award_promotiondesc'] = '通过本任务可以自动对符合条件的用户授予勋章'; 
$a_lang['mysql']['cron']['rebuildglobalstick'] = '重建总置顶主题'; 
$a_lang['mysql']['cron']['rebuildglobalstickdesc'] = '重新建立总置顶主题的各种相关信息'; 
...
$a_lang['mysql']['setting']['gdversion'] = "GD 库版本";
$a_lang['mysql']['setting']['gdversiondesc'] = "你的服务器所安装的GD库版本。如果GD库已安装，你可以在phpinfo()信息中发现。";
$a_lang['mysql']['setting']['isajax'] = "是否在全局使用AJAX技术";
$a_lang['mysql']['setting']['isajaxdesc'] = "如果使用AJAX技术的话，则用户可以更方便的进行无刷新页面操作，减少服务器带宽，但同时相应会对用户浏览器增加部分负担。";
...
$a_lang['mysql']['setting']['redirecturl'] = "默认页面跳转地址";
$a_lang['mysql']['setting']['redirecturldesc'] = "当系统无法获取要跳转的页面URL地址时，默认将程序跳转到的位置。";
$a_lang['mysql']['setting']['redirecturlextra'] = "1=论坛首页\n2=网站首页";
...
$a_lang['mysql']['setting']['titlechangeposts'] = "用户的发帖量达到多少才可以使用自定义头衔？";
$a_lang['mysql']['setting']['titlechangepostsdesc'] = "对于可以使用自定义用户头衔的用户组的限定值。留空将忽略此参数。";
$a_lang['mysql']['setting']['locationmaxlength'] = "用户在“来自”部分允许输入的最大字数";
...
$a_lang['mysql']['setting']['removesubscibe'] = "自动删除 x 天内没有新回复的订阅主题";
$a_lang['mysql']['setting']['removesubscibedesc'] = "留空或输入 0 将禁止自动删除。";
$a_lang['mysql']['setting']['avatarsenabled'] = "允许用户使用头像？";
$a_lang['mysql']['setting']['defaultavatar'] = "默认头像的文件名";
$a_lang['mysql']['setting']['defaultavatardesc'] = "请将默认头像放置在./images/avatars/目录内。留空将不调用系统默认头像。";
$a_lang['mysql']['setting']['avatarextension'] = "允许使用的头像文件扩展名";
$a_lang['mysql']['setting']['avatarextensiondesc'] = "请使用逗号分开每个扩展名。";
$a_lang['mysql']['setting']['avatarurl'] = "允许用户头像使用远程URL链接？";
$a_lang['mysql']['setting']['avatamaxsize'] = "可上传头像的最大字节数 (单位: KB)";
$a_lang['mysql']['setting']['avatardimension'] = "头像的最大尺寸";
$a_lang['mysql']['setting']['avatardimensiondesc'] = "(宽度 <b>x</b> 高度)";
$a_lang['mysql']['setting']['avatardimensiondefault'] = "头像库的默认尺寸";
$a_lang['mysql']['setting']['avatardimensiondefaultdesc'] = "(宽度 <b>x</b> 高度)";
$a_lang['mysql']['setting']['avatarcolspannumbers'] = "头像库列表的列数";
$a_lang['mysql']['setting']['disableavatarsize'] = "禁止论坛将头像自动缩放？";
$a_lang['mysql']['setting']['disableavatarsizedesc'] = "如果禁止，用户头像大小将不自动缩放。";
$a_lang['mysql']['setting']['guestviewsignature'] = "允许游客查看会员签名？";
$a_lang['mysql']['setting']['guestviewimg'] = "允许游客直接查看帖子内的图片？";
$a_lang['mysql']['setting']['guestviewavatar'] = "允许游客查看用户头像？";
$a_lang['mysql']['setting']['award_deduct'] = "申请荣誉勋章花费的资金";
$a_lang['mysql']['setting']['award_deductdesc'] = "用户每次申请颁发荣誉勋章所扣除的金钱及积分。请使用（金钱|积分）的方式设定参数。";
$a_lang['mysql']['setting']['maxpostchars'] = "每个帖子最大的字数";
$a_lang['mysql']['setting']['minpostchars'] = "每个帖子最小的字数";
$a_lang['mysql']['setting']['maxflashwidth'] = "FLASH 贴图显示的宽度 (单位: 像素)";
$a_lang['mysql']['setting']['maxflashwidthdesc'] = "如果 [flash] 标签开启的情况下";
$a_lang['mysql']['setting']['maxflashheight'] = "FLASH 贴图显示的高度 (单位: 像素)";
$a_lang['mysql']['setting']['maxflashheightdesc'] = "如果 [flash] 标签开启的情况下";
$a_lang['mysql']['setting']['perlineicons'] = "每行显示的发帖图标数量";
$a_lang['mysql']['setting']['rowsmiles'] = "在表情符号表单中显示的表情符号行数";
$a_lang['mysql']['setting']['rowsmilesdesc'] = "这个表单显示在在发帖页面中。";
$a_lang['mysql']['setting']['perlinesmiles'] = "在表情符号表单中显示的表情符号列数";
$a_lang['mysql']['setting']['perlinesmilesdesc'] = "这个表单显示在在发帖页面中。";
...
$a_lang['mysql']['setting']['addpolltimeout'] = "在主题作者发表主题后多长时间内可以在主题内添加一个投票？";
$a_lang['mysql']['setting']['addpolltimeoutdesc'] = "对管理员及超级版主不起作用";
...
$a_lang['mysql']['setting']['allowflash'] = "允许在头像中使用 FLASH 标签？";
$a_lang['mysql']['setting']['allowflashdesc'] = "由于 Flash 代码内可以使用脚本语言，因此可能会造成一些不安全隐患，在你确认论坛绝对安全的情况下才可以启用此功能。";
...
$a_lang['mysql']['setting']['shownewslink'] = "是否在论坛首页显示 “最新新闻” 的链接？";
$a_lang['mysql']['setting']['newsforumid'] = "用于显示新闻的论坛";
...
$a_lang['mysql']['setting']['autohidebirthday'] = "当没有过生日的会员的时候隐藏过生日的会员列表？";
$a_lang['mysql']['setting']['autohidebirthdaydesc'] = "如果设置为是的话，当上面的选项开启，并且在当天没没有过生日的会员情况下，将隐藏这部分页面。";
...
$a_lang['mysql']['setting']['gstickyprefix'] = "“总置顶主题” 的前缀";
$a_lang['mysql']['setting']['stickyprefix'] = "“置顶主题” 的前缀";
$a_lang['mysql']['setting']['movedprefix'] = "“移动主题” 的前缀";
$a_lang['mysql']['setting']['pollprefix'] = "“投票主题” 的前缀";
...
$a_lang['mysql']['setting']['showmoderatorcolumn'] = "是否显示版主列";
$a_lang['mysql']['setting']['showmoderatorcolumndesc'] = "在首页、论坛显示页面和用户控制面板页面开启或关闭显示版主列。";
$a_lang['mysql']['setting']['stickopentag'] = "置顶主题修饰前缀";
$a_lang['mysql']['setting']['stickopentagdesc'] = "用于修饰置顶主题的HTML标签前缀";
$a_lang['mysql']['setting']['stickclosetag'] = "置顶主题修饰后缀";
$a_lang['mysql']['setting']['stickclosetagdesc'] = "用于修饰置顶主题的HTML标签后缀";
...
$a_lang['mysql']['setting']['showdescription'] = "开启主题说明功能";
$a_lang['mysql']['setting']['showdescriptiondesc'] = "如果关闭主题说明功能，在主题列表内将不显示主题说明选项";
...
$a_lang['mysql']['setting']['newregisterpost'] = "注册后限制发帖时限";
$a_lang['mysql']['setting']['newregisterpostdesc'] = "对新注册用户，在注册后 x 分钟内才可以正常使用发帖功能。";
$a_lang['mysql']['setting']['registerrule'] = "注册声明";
$a_lang['mysql']['setting']['newuser_give'] = "新注册用户初始化给与的资金及积分";
$a_lang['mysql']['setting']['newuser_givedesc'] = "新注册用户初始化的资金及积分值。请使用（金钱|积分）的方式设定参数。";
...
$a_lang['mysql']['setting']['openbank'] = "银行开放状态";
$a_lang['mysql']['setting']['openbankdesc'] = "是否开放银行";
$a_lang['mysql']['setting']['bankcurrency'] = "货币单位";
$a_lang['mysql']['setting']['bankcurrencydesc'] = "用于计算货币的单位名称。";
$a_lang['mysql']['setting']['bankcost'] = "开户费用";
$a_lang['mysql']['setting']['bankcostdesc'] = "在银行中开户所需费用，现金不足者不能创建银行帐户。";
$a_lang['mysql']['setting']['bankinterest'] = "存款利率";
$a_lang['mysql']['setting']['bankinterestdesc'] = "银行存款的日利率，当用户处于贷款状态时不计算利息。计算单位：‰";
$a_lang['mysql']['setting']['bankexcost'] = "转帐手续费";
$a_lang['mysql']['setting']['bankexcostdesc'] = "用户之间转帐收取的手续费。计算单位：‰";
$a_lang['mysql']['setting']['bankexcostskip'] = "转帐手续费补充";
$a_lang['mysql']['setting']['bankexcostskipdesc'] = "当一次性转帐数额小于本设置值时，不收取转帐手续费。";
$a_lang['mysql']['setting']['banknewthread'] = "发表新帖的奖励";
$a_lang['mysql']['setting']['banknewthreaddesc'] = "用户发表新帖时奖励的金钱数量。";
$a_lang['mysql']['setting']['bankreplythread'] = "回复帖子的奖励";
$a_lang['mysql']['setting']['bankreplythreaddesc'] = "用户回复一个主题时奖励的金钱数量。";
$a_lang['mysql']['setting']['bankquint'] = "设置为精华的奖励";
$a_lang['mysql']['setting']['bankquintdesc'] = "当一个用户的帖子被设置为“精华帖”时奖励的金钱数量。";
$a_lang['mysql']['setting']['bankrepprice'] = "积分买入价";
$a_lang['mysql']['setting']['bankreppricedesc'] = "用户以现金购买积分的价格。单位：元/1积分";
$a_lang['mysql']['setting']['bankrepsellprice'] = "积分卖出价";
$a_lang['mysql']['setting']['bankrepsellpricedesc'] = "用户变卖积分为现金的价格。";
$a_lang['mysql']['setting']['bankloanonoff'] = "贷款功能";
$a_lang['mysql']['setting']['bankloanonoffdesc'] = "是否启用贷款功能？";
$a_lang['mysql']['setting']['bankloanreglimit'] = "申请贷款的最低注册时间";
$a_lang['mysql']['setting']['bankloanreglimitdesc'] = "会员自注册成功多久后可以申请贷款。计算单位：小时";
$a_lang['mysql']['setting']['bankloanpostlimit'] = "申请贷款的最低发贴要求";
$a_lang['mysql']['setting']['bankloanpostlimitdesc'] = "会员需达到多少发贴量后方可申请贷款。";
$a_lang['mysql']['setting']['bankloanreplimit'] = "申请贷款的最低积分要求";
$a_lang['mysql']['setting']['bankloanreplimitdesc'] = "积分低于此设置的用户不能申请贷款。";
$a_lang['mysql']['setting']['bankloanusegroup'] = "使用分组信誉机制";
$a_lang['mysql']['setting']['bankloanusegroupdesc'] = "根据不同用户组设置相应信誉额上限。具体设置请到“用户组管理”面板进行操作。";
$a_lang['mysql']['setting']['bankloanamount'] = "贷款信誉额";
$a_lang['mysql']['setting']['bankloanamountdesc'] = "每个用户可以贷款的额度。在下列情况时此设置无效：1、选择了“分组信誉机制”；2、游客和等待验证用户没有信誉额；";
$a_lang['mysql']['setting']['bankloantimelimit'] = "贷款偿还期额";
$a_lang['mysql']['setting']['bankloantimelimitdesc'] = "自贷款当日起，直至偿还贷款的时间限额，可用半角逗号提供用户不同的贷款计划，同时在“贷款利息”中填写不同的贷款利率。计算单位：天";
$a_lang['mysql']['setting']['bankloaninterest'] = "贷款利息";
$a_lang['mysql']['setting']['bankloaninterestdesc'] = "偿还贷款时所计算的利息，必须对应贷款期额分别写出偿款利率，否则将以第一个利率计算。计算单位：‰";
$a_lang['mysql']['setting']['bankpbban'] = "破产封ID惩罚";
$a_lang['mysql']['setting']['bankpbbandesc'] = "如果用户因为某些原因导致破产，则封禁ID作为惩罚。计算单位：天";
$a_lang['mysql']['setting']['bankpbrerate'] = "强制执行固定资产评估水平";
$a_lang['mysql']['setting']['bankpbreratedesc'] = "当用户在偿还贷款之日仍未偿还，则由银行进行强制执行。强制执行过程中，如用户的资金总额不足以偿还贷款和利息，则变卖所有固定资产进行偿还。此设置为资产评估水平，即物品按市场价格的折价率。计算单位：%";
$a_lang['mysql']['setting']['bankpbreppanish'] = "强制执行的积分处罚";
$a_lang['mysql']['setting']['bankpbreppanishdesc'] = "如果用户贷款被强制收回或资产被强制执行，扣除多少积分作为惩罚？";
$a_lang['mysql']['setting']['bankpbclean'] = "破产后银行清产费用";
$a_lang['mysql']['setting']['bankpbcleandesc'] = "用户破产后需要在银行清产才能再次申请帐户的费用。";
$a_lang['mysql']['setting']['reducetmoney'] = "删除主题惩罚";
$a_lang['mysql']['setting']['reducetmoneydesc'] = "删除一个主题扣除的金钱数量。";
$a_lang['mysql']['setting']['reducepmoney'] = "删除帖子惩罚";
$a_lang['mysql']['setting']['reducepmoneydesc'] = "删除一个帖子扣除的金钱数量。";
$a_lang['mysql']['setting']['version'] = "";
$a_lang['mysql']['setting']['openolrank'] = "开启在线时长等级功能？";
$a_lang['mysql']['setting']['openolrankdesc'] = "是否开启在线时长等级功能。如果选择“否”，那么对应的在线时长等级相关的功能将全部关闭。";
$a_lang['mysql']['setting']['olrankstart'] = "起步时长";
$a_lang['mysql']['setting']['olrankstartdesc'] = "在线时长等级第一级所需的时长（小时数）";
$a_lang['mysql']['setting']['olrankstep'] = "递进时长";
$a_lang['mysql']['setting']['olrankstepdesc'] = "升级到下一级别比升级到此级别增加的时长。比如，如果递进时长为5，升级到第1级需要10小时，升级到第2级则需要10+5=15小时，第3级需要20小时，以此类推。";
$a_lang['mysql']['setting']['isopeninvite'] = "是否打开邀请注册";
$a_lang['mysql']['setting']['nolimitinviteusergroup'] = "选择拥有无限邀请权的用户组";
$a_lang['mysql']['setting']['nolimitinviteusergroupdesc'] = "按Shift或Ctrl选择多个";
$a_lang['mysql']['setting']['limitinvitegroup'] = "选择拥有限制邀请权的用户组";
$a_lang['mysql']['setting']['limitinvitegroupdesc'] = "按Shift或Ctrl选择多个";
$a_lang['mysql']['setting']['limitregtime'] = "用户注册时间达到";
$a_lang['mysql']['setting']['limitregtimedesc'] = "发送无限邀请权限此项不填（单位：天）";
$a_lang['mysql']['setting']['limitposttitlenum'] = "用户发帖数达到";
$a_lang['mysql']['setting']['inviteminnum'] = "用户最少可以有几个邀请权限";
$a_lang['mysql']['setting']['invitemaxnum'] = "用户最多可以有几个邀请权限";
$a_lang['mysql']['setting']['invitexpiry'] = "具有限制邀请注册权限用户的使用期限";
$a_lang['mysql']['setting']['inviteduserexpiry'] = "用户发出邀请后几天内注册有效";
$a_lang['mysql']['setting']['timenotlogin'] = "仅对多长时间有登录的用户发放";
$a_lang['mysql']['setting']['timenotlogindesc'] = "若用户在设定时间之内没登录过将不能得到该权限（单位：天）";
$a_lang['mysql']['setting']['modreptype'] = "评分类型奖励";
$a_lang['mysql']['setting']['modreptypedesc'] = "用户组有权利给某些用户奖励或处罚,可以选择加分或者加社区币.";
$a_lang['mysql']['setting']['modrepmax'] = "社区币奖励限制金额";
$a_lang['mysql']['setting']['modrepmaxdesc'] = "奖励会员的最大数额及最小数额,在设置该值的正负之间.";
...
$a_lang['mysql']['setting']['gstickyprefixdval'] = "总置顶: ";
$a_lang['mysql']['setting']['stickyprefixdval'] = "置顶: ";
$a_lang['mysql']['setting']['movedprefixdval'] = "移动: ";
...
$a_lang['mysql']['setting']['bankcurrencydval'] = "金币";
...
$a_lang['mysql']['usergroup']['waittingvalidate'] = "等待验证的会员";
$a_lang['mysql']['usergroup']['guest'] = "游客";
$a_lang['mysql']['usergroup']['regmember'] = "注册会员";
$a_lang['mysql']['usergroup']['admin'] = "管理员";
$a_lang['mysql']['usergroup']['banuser'] = "被封禁会员";
$a_lang['mysql']['usergroup']['supermod'] = "超级版主";
...
$a_lang['mysql']['setting']['moderatorlist'] = '版主显示方式';
$a_lang['mysql']['setting']['moderatorlistd'] = '下拉菜单';
$a_lang['mysql']['setting']['moderatorlisth'] = '平面显示';
...
$a_lang['mysql']['setting']['quickeditordisplaymenu'] = '快速回复编辑器是否显示菜单';
$a_lang['mysql']['setting']['quickeditordisplaymenudesc'] = '快速回复编辑器是否显示上排操作按钮。设为“否”可以加快编辑器载入速度。';
