...
class statistics {
	...
	function main_screen()
	{
		...
		$forums->admin->print_input_select_row( 'resulttype', array(
			0 => array('show_reg', $forums->lang['registerstats']),
		...
		$forums->admin->print_input_select_row( "from_year"  , $this->year() , $old_date['year'] ).'&nbsp;&nbsp;'.
		$forums->admin->print_input_select_row( "from_month" , $this->month(), $old_date['mon']  ).'&nbsp;&nbsp;'.
		$forums->admin->print_input_select_row( "from_day"   , $this->day()  , $old_date['mday'] )
		)      );
		$forums->admin->print_cells_row( array( "<strong>".$forums->lang['enddate']."</strong>" ,
		$forums->admin->print_input_select_row( "to_year"  , $this->year() , $new_date['year'] ).'&nbsp;&nbsp;'.
		$forums->admin->print_input_select_row( "to_month" , $this->month(), $new_date['mon']  ).'&nbsp;&nbsp;'.
		$forums->admin->print_input_select_row( "to_day"   , $this->day()  , $new_date['mday'] )
		)      );
		if ($mode != 'views') {
