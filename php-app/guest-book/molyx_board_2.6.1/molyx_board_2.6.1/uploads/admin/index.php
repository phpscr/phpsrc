...
class index {
	...
	function showindex()
	{
		...
		if($hidenews) {
			...
			$forums->admin->print_cells_single_row( "<script type='text/javascript' src='http://www.molyx.com/clientscripts/updatenews.js'></script>\n" );
		}
		$forums->admin->print_table_footer();
		...
		$time = TIMENOW - 60*10;
		$DB->query( "SELECT username, location, logintime, lastactivity, host FROM ".TABLE_PREFIX."adminsession WHERE lastactivity > ".$time."" );
		$time_now = time();
		$seen_name = array();
		...
		$forums->admin->print_table_footer();
		$reg = $DB->query_first( "SELECT COUNT(*) as reg FROM ".TABLE_PREFIX."useractivation WHERE type <> 1" );
		...
		$forums->admin->print_cells_row( array( $forums->lang['totalthreads'].": ".$forums->func->fetch_number_format($forums->cache['stats']['totalthreads']),
																 $forums->lang['totalposts'].": ".$forums->func->fetch_number_format($forums->cache['stats']['totalposts']),
														)      );
		$forums->admin->print_cells_row( array( $forums->lang['totalusers'].": ".$forums->func->fetch_number_format($forums->cache['stats']['numbermembers']), "<a href='user.php?{$forums->sessionurl}do=mod'>".$forums->lang['totalmodusers']."</a>: ".$forums->func->fetch_number_format($reg['reg']) ) );
		$forums->admin->print_table_footer();
		...
		$forums->admin->print_cells_row( array( "<strong>".$forums->lang['developer'].":</strong>",
												  "<a href='http://www.hogesoft.com' target='_blank'>".$forums->lang['hogesoftco']."</a>"
										 )      );
		$forums->admin->print_cells_row( array( "<strong>".$forums->lang['productmanager'].":</strong>",
												  "<a href='http://www.molyx.com/profile.php?u=1601' target='_blank'>FlyingHail</a>"
										 )      );
		$forums->admin->print_cells_row( array( "<strong>".$forums->lang['productadvisor'].":</strong>",
												  "<a href='http://www.molyx.com/profile.php?u=1' target='_blank'>firefox</a>, <a href='http://www.molyx.com/profile.php?u=2' target='_blank'>jiangcat</a>, <a href='http://www.hogesoft.com' target='_blank'>Sancho</a>"
										 )      );
		$forums->admin->print_cells_row( array( "<strong>".$forums->lang['team'].":</strong>",
												  "<a href='http://www.molyx.com/profile.php?u=1' target='_blank'>firefox</a>, <a href='http://www.molyx.com/profile.php?u=2' target='_blank'>jiangcat</a>, <a href='http://www.hogesoft.com' target='_blank'>Sancho</a>, <a href='http://www.molyx.com/profile.php?u=4912' target='_blank'>liverXing</a>, <a href='http://www.molyx.com/profile.php?u=5154' target='_blank'>firstplan</a>, <a href='http://www.molyx.com/profile.php?u=1650' target='_blank'>Justlau</a>, <a href='http://www.molyx.com/profile.php?u=1766' target='_blank'>ybb</a>, <a href='http://www.molyx.com/profile.php?u=1601' target='_blank'>FlyingHail</a>, <a href='http://www.molyx.com/profile.php?u=12703' target='_blank'>kinch</a>, <a href='http://www.molyx.com/profile.php?u=13441' target='_blank'>lixiangyang</a>, <a href='http://www.molyx.com/profile.php?u=15202' target='_blank'>guyefeng</a>"
										 )      );
		$forums->admin->print_cells_row( array( "<strong>".$forums->lang['hackergroup'].":</strong>",
												  "<a href='http://www.molyx.com/profile.php?u=5336' target='_blank'>BreakNife</a>, <a href='http://www.molyx.com/profile.php?u=4592' target='_blank'>KissVenus</a>, <a href='http://www.molyx.com/profile.php?u=1536' target='_blank'>kavenzou</a>, <a href='http://www.molyx.com/profile.php?u=7748' target='_blank'>foliage</a>, <a href='http://www.molyx.com/profile.php?u=77' target='_blank'>bensunan</a>, <a href='http://www.molyx.com/profile.php?u=844' target='_blank'>Leez</a>"
										 )      );
		$forums->admin->print_table_footer();
	...
	{
		global $DB, $forums, $_INPUT, $bbuserinfo, $bboptions;
		$DB->query_unbuffered("DELETE FROM ".TABLE_PREFIX."adminsession WHERE userid=".$bbuserinfo['id']."");
